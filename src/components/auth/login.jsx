    ...
    <Card className="w-full max-w-md backdrop-blur-md bg-card/80 border-border/50 shadow-2xl">
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button
            type="submit"
            className="w-full bg-secondary hover:bg-black hover:text-white text-secondary-foreground font-medium py-2.5 transition-all duration-200 hover:shadow-lg hover:shadow-secondary/25"
          >
            Sign In
          </Button>
          ...
          {/* <div className="grid grid-cols-2 gap-4">
            <Button
              variant="outline"
              className="bg-input/40 backdrop-blur-sm border-border/50 text-card-foreground hover:bg-input/60 transition-all duration-200"
            >
