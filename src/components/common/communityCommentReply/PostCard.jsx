        ...
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-gray-500">12/12/2021</span>
            </div>
          </CardTitle>

          <CardAction className="border border-gray-200 rounded-full p-1 hover:bg-gray-100 hover:scale-110 transition-all duration-300 cursor-pointer">
            <PiHighlighterFill size={20} className="text-black" />
          </CardAction>
        </CardHeader>
        <CardContent>
          <p className="text-sm text-gray-500">
            This is what i learned in my recent course “The whole secret of
            existence”.......
          </p>
        </CardContent>
