...
import { useGiveBhaFeedbackMutation } from "@/redux/Apis/bha/reportApi/reportApi";
import useToast from "@/hooks/useToast";
import { useRouter } from "next/navigation";

function ClientOverviewReport({ clientReports = [], isLoading = false }) {
  ...
  // Show only 5 clients
  const displayedClients = clientReports.slice(0, 5);
